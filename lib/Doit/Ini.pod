...
=head1 SYNOPSIS
    ...
    $doit->ini_change('/path/to/file.ini', 'section1.key1' => 'newval1', 'section2.key2' => 'newval2', ...);
...
Change an existing ini file. There is a simple mode with key-value
arguments, and a mode where an anonymous subroutine may be provided.
